...
import 'schema/my_events_record.dart';
...
export 'schema/my_events_record.dart';
...
Stream<List<RegistrationRecord>> queryRegistrationRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      RegistrationRecord.collection,
      RegistrationRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
Stream<List<CommentsAndRateRecord>> queryCommentsAndRateRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      CommentsAndRateRecord.collection(parent),
      CommentsAndRateRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
Stream<List<UnethicalIllegalConductReportRecord>>
  ...
  bool singleRecord = false,
        ...
        queryCollection(
          UnethicalIllegalConductReportRecord.collection,
          UnethicalIllegalConductReportRecord.fromSnapshot,
          queryBuilder: queryBuilder,
          limit: limit,
          singleRecord: singleRecord,
        );
...
Stream<List<FalseInformationReportRecord>> queryFalseInformationReportRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      FalseInformationReportRecord.collection,
      FalseInformationReportRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
Stream<List<MemoralizationReportRecord>> queryMemoralizationReportRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      MemoralizationReportRecord.collection,
      MemoralizationReportRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
Stream<List<MonthlyCreatedEventRecord>> queryMonthlyCreatedEventRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      MonthlyCreatedEventRecord.collection,
      MonthlyCreatedEventRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
/// Functions to query MyEventsRecords (as a Stream and as a Future).
Future<int> queryMyEventsRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MyEventsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MyEventsRecord>> queryMyEventsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      MyEventsRecord.collection(parent),
      MyEventsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MyEventsRecord>> queryMyEventsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<MyEventsRecord>> queryMyEventsRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
