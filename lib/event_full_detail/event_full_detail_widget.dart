        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('EVENT_FULL_DETAIL_arrow_back_rounded_ICN');
              ...
              Visibility(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('EVENT_FULL_DETAIL_trashAlt_ICN_ON_TAP');
                      logFirebaseEvent('IconButton_bottom_sheet');
                      await showModalBottomSheet(
                        isScrollControlled: true,
                        backgroundColor: Colors.transparent,
                        ...
                        builder: (context) {
                          return Padding(
                            ...
                            child: ConfirmDeleteWidget(
                              eventRef: eventFullDetailEventsRecord.reference,
                              isEvent: true,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              valueOrDefault<String>(
                                eventFullDetailEventsRecord.eventInChargePerson,
                                'In Charge',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyText1
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              valueOrDefault<String>(
                                eventFullDetailEventsRecord.eventContactNumber,
                                'contact Number',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyText1
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                dateTimeFormat(
                                  'relative',
                                  eventFullDetailEventsRecord.createdDate!,
                                  locale:
                                      FFLocalizations.of(context).languageCode,
                                ),
                                style: FlutterFlowTheme.of(context)
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                StreamBuilder<List<CommentsAndRateRecord>>(
                                    ...
                                    children: [
                                      RatingBar.builder(
                                        onRatingUpdate: (newValue) {
                                          ...
                                          setState(() {
                                            FFAppState().rateIsTapped = true;
                                            FFAppState().rateValue =
                                                functions.rateSuggestion(_model
                                                    .ratingBarValue2!
                                                    .round());
                                          });
                                        },
